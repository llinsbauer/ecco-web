System.register(['angular2/platform/browser', 'angular2/http', 'angular2/router', 'angular2/core', './ecco.component', './settings.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            browser_1.bootstrap(ecco_component_1.MainRouterComponent, [http_1.HTTP_PROVIDERS, router_1.ROUTER_PROVIDERS, settings_service_1.SettingsService, core_1.provide(ecco_component_1.DEFAULT_REPO_URL, { useValue: 'repo/' }), core_1.provide(router_2.LocationStrategy, { useClass: router_2.HashLocationStrategy })]);
        }
    }
});
